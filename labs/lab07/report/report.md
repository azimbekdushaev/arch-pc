...
![Программа lab7-p1.asm](image/12.png){ #fig:012 width=70%, height=70% }

![Запуск программы lab7-p1.asm](image/13.png){ #fig:013 width=70%, height=70% }
...
![Программа lab7-p2.asm]](image/14.png){ #fig:014 width=70%, height=70% }

Подставляем $x=1, a=2$ и $x=2, a=1$

![Запуск программы lab7-p2.asm]](image/15.png){ #fig:015 width=70%, height=70% }
